...
// static const MOVIE_BY_ID = (movieId: string) => '/movie/${movieId}?language=pt-BR&api_key=${kApiKey}';
// static const SERIE_BY_ID = (serieId: string) => '/tv/${serieId}?language=pt-BR&api_key=${kApiKey}';
static const kNetflixImgRow = 'https://image.tmdb.org/t/p/w300';
static const kNetflixFeatured = 'https://image.tmdb.org/t/p/original';
static const kNetflixLoading = 'https://media.wired.com/photos/592744d3f3e2356fd800bf00/master/w_600,c_limit/Netflix_LoadTime.gif';
}